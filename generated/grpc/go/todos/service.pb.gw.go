...
func request_TodoService_Healtz_0(ctx context.Context, marshaler runtime.Marshaler, client TodoServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func RegisterTodoServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client TodoServiceClient) error {
	...
	mux.Handle("GET", pattern_TodoService_Healtz_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_TodoService_Healtz_0(rctx, inboundMarshaler, client, req, pathParams)
		...
		forward_TodoService_Healtz_0(ctx, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
var (
	pattern_TodoService_Healtz_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1}, []string{"v1", "healtz"}, ""))
)

var (
	forward_TodoService_Healtz_0 = runtime.ForwardResponseMessage
)
